...
void CNameCardDlg::InitializePropGrid(NameCard card)
{
	...
	pGroupPrint->AddSubItem(new CMFCPropertyGridFontProperty(_T("이름 글꼴"), card.lfName, CF_EFFECTS | CF_SCREENFONTS, _T("회사명, 직책, 이름의 글꼴을 지정합니다."), 6));

	CMFCPropertyGridColorProperty* pColor = new CMFCPropertyGridColorProperty(_T("텍스트 색상"), card.colorText, NULL, _T("출력할 텍스트의 기본색상을 지정합니다."), 7);
